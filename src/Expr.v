...
Lemma strictness (e e' : expr) (HSub : e' << e) (st : state Z) (z : Z) (HV : [| e |] st => z) :
  exists z' : Z, [| e' |] st => z'.
Proof.
  generalize dependent z; induction HSub; intros.
  - exists z. assumption.
  - inversion HV; subst; apply IHHSub in VALA; assumption.
  - inversion HV; subst; apply IHHSub in VALB; assumption.
Qed.
...
Proof. 
  ...
  induction e; intros.
  - inversion ID.
  - inversion RED. subst. exists z. inversion ID; subst. apply VAR.
...
Proof. 
  ...
  - inversion E1; subst; inversion E2; subst;
    try (rewrite (IHe1 za VALA za0 VALA0) in *;
         rewrite (IHe2 zb VALB zb0 VALB0) in *
    );
    try reflexivity;
    try contradiction.
Qed.
...
Proof. 
  constructor; intros; apply EQ; auto.
Qed.
...
Lemma eq_eq_ceq (e1 e2 : expr) :
  e1 ~~ e2 <-> e1 ~c~ e2.
Proof. 
  unfold contextual_equivalent. unfold equivalent. split.
...
Module SmallStep.
  ...
  Proof.
    ...
    - rewrite Heqe0. apply ss_Left. constructor. auto.
    - rewrite Heqe1. apply ss_Right. constructor. auto. 
  Qed.
...
Module Renaming.
  ...
  Proof.
    ...
    - auto.
    - destruct a, r, r'. 
      simpl. rewrite IHst, Hinv. reflexivity.
  Qed.
