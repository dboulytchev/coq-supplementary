...
Proof.
  intros.
  destruct (lt_eq_lt_id_dec id1 id2) as [[H0|H1]|H2].
  - right. destruct H0.
    inversion H. subst. apply gt_conv. lia.
  - left. apply H1.
  - left. inversion H2. subst. inversion H. subst. lia.
Qed.
...
Proof.
  intros.
  destruct (gt_eq_gt_id_dec id1 id2) as [[H0|H1]|H2].
  - left. apply H0.
  - contradiction.
  - right. apply H2.
Qed.
